...
```{r, out.height = "350px", out.width = "100%"}
knitr::include_graphics("https://raw.githubusercontent.com/Stefan1896/Holiday_Package_Prediction/main/Scripts/reisen.PNG?raw=true")
```
*Photo by Elena Akifeva on alamy.*

# Introduction

I am happy to complete my first Machine Learning Project on Kaggle. As I am quite new to this topic, i am really thankful for any comments and thoughts on possible improvements!
...
```{r}
#get data
travel <- fread("../input/holiday-package-purchase-prediction/Travel.csv")
...
- The red line represents our measured difference in median MonthlyIncome between our two groups (value: `r diff_med[[1]]`). This red line is far in the left tail of the distribution and looks atypical, which indicates a small p-value.
